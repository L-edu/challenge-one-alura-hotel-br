...
public class Buscar extends JFrame {
	...
	private HospedeController hospedesController;
	...
	public Buscar() {
		...
		this.hospedesController = new HospedeController();
		...
		logo.setIcon(new ImageIcon(Buscar.class.getResource("/imagenes/Ha-100px.png")));
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (filaHospedes >= 0) {
					...
					JOptionPane.showMessageDialog(null,
							"Erro: fileira não selecionada, por favor realize uma busca e selecione uma fileira para excluir");
				}
			}
		});
	...
	private void atualizarReservas() {
		...
		if (objetoDaLinha instanceof Integer) {
			...
			reservaController.atualizar(dataEntrada, dataSaida, valor, pagamento, id);
		} else {
